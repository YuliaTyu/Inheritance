...
using std::cout;
using std::endl;
#define HUMAN_TAKE_PARAMETERS const std::string& last_name, const std::string& first_name, int age//ÏÐÈÍÈÌÀÅÌÛÅ
#define HUMAN_GIV_PARAMETERS last_name, first_name, age//ÏÅÐÅÄÀÂÀÅÌÛÅ
...
void main()
{
	...
	Teacher teacher("White", "Walter", 50, "Chemisrty", 25);
	teacher.info();
